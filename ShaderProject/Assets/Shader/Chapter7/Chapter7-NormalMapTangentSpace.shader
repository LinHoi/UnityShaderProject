...
/*	Properties
	{
		...
		_BumpScale("Bump Scale",Float) = 1.0//凹凸系数
	}
		SubShader
		{
			...
			Pass
		{
			...
			#include "Lighting.cginc"
				...
				fixed4 frag(v2f i) : SV_Target{
					...
					tangentNormal.z = sqrt(1.0 - saturate(dot(tangentNormal.xy, tangenNormal.xy)));
					...
					//漫反射方程
					fixed3 diffuse = _LightColor0.rgb * _Color.rgb * saturate(dot(tangentNormal, tangentLightDir));
					//高光
